...
<buntu>Ubuntu從版本『9.10(Karmic Koala)』開始就一直用GRUB2當它的預設bootloader，而在Ubuntu版本『11.04(Natty Narwhal)』時GRUB2版本1.99已經變成新的預設，我在寫這篇文章的時候，用的Ubuntu版本是『16.04(Xenial Xerus)』，GRUB2的版本是『2.02~beta2-36ubuntu3.1』。</buntu>
